...
# Loop through each region and train the model (randomforest)
for region in regions:
...
# Full pipeline for KNN (only Numerical variables)
knn_num_pipeline = Pipeline(steps=[
    ("preprocessor", ColumnTransformer(transformers=[("num", numerical_transformer, numerical_cols)])),
    ("knn", KNeighborsRegressor())  
])

# Full pipeline for Random Forest (only Numerical variables)
...
# Full pipeline for KNN Regressor
...
# Full pipeline for Random Forest Regressor
